      ...
      <div className="w-full flex flex-col justify-center items-center px-8">
        ...
        <div className="text-xl mb-6 text-greenDark max-w-3xl">
          ...
          <p className="leading-relaxed">
            Our mission is to create a welcoming, safe space where individuals of all
            backgrounds, ages, and socioeconomic statuses can feel a sense of community by building
            strong, supportive bonds that empower them to embrace their values and heritage with confidence.
          </p>
          ...
          <p className="leading-relaxed">
            Our vision is to uplift a community where everyone feels valued, supported, and
